...
import (
	...
	"github.com/imjasonh/pasta/pkg/pastals/jsonrpc"
	"github.com/imjasonh/pasta/pkg/pastals/protocol"
...
func (s *Server) reloadRules() {
	...
	// pkg/runner.LoadRules expects a directory containing *.cue files,
